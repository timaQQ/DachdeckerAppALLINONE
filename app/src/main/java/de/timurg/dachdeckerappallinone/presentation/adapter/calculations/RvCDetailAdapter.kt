...
class RvCDetailAdapter(val context: Context, var dataset: List<CListItem>):
    RecyclerView.Adapter<RvCDetailAdapter.ItemViewHolder>() {
        ...
        with(holder){
            ...
            listCard.setOnClickListener {
                holder.itemView.findNavController()
                    .navigate(CalculationsFragmentDirections
